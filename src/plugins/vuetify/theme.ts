...
const theme: VuetifyOptions['theme'] = {
  ...
  themes: {
    light: {
      dark: false,
      colors: {
        'primary': localStorage.getItem(`${themeConfig.app.title}-lightThemePrimaryColor`) || '#2459A0',
        'on-primary': '#fff',
        'secondary': '#8CAEDE',
        'on-secondary': '#fff',
        'success': '#8CAEDE',
    ...
    dark: {
      dark: true,
      colors: {
        'primary': localStorage.getItem(`${themeConfig.app.title}-darkThemePrimaryColor`) || '#F8AD24',
        'on-primary': '#fff',
        'secondary': '#A8AAAE',
        'on-secondary': '#fff',
        'success': '#28C76F',
